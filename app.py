...
import re
#Load Models
rf_classifier_categorization = pickle.load(open(r"models\rf_classifier_categorization.pkl","rb"))
tfidf_vectorizer_categorization = pickle.load(open(r"models\tfidf_vectorizer_categorization.pkl","rb"))
        ...
        if "resume" in request.files:
            ...
            if filename.endswith(".pdf"):
               text = pdf_to_text(file)
                ...
                return render_template("resume.html", message="Invalid resume file format. Please upload .pdf or .txt file ")
